...
namespace EarlyPusher.Modules.TimeShockTab.ViewModels
{
    public class OperateTimeShockVM : OperateTabVMBase
    {
        ...
        public ObservableCollection<ImageItemViewModel> CorrectImageItems { get; } = new ObservableCollection<ImageItemViewModel>();

        public ObservableCollection<ImageItemViewModel> TimerImageItems { get; } = new ObservableCollection<ImageItemViewModel>();
